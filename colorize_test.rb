...
print String.colors                       # return array of all possible colors names
print  String.modes                        # return array of all possible modes
...
puts "This is blue".colorize(:blue).underline
puts "This is light blue".colorize(:light_blue).bold
puts "This is also blue".colorize(:color => :blue).italic
puts "This is light blue with red background".colorize(:color => :light_blue, :background => :red)
puts "This is light blue with red background".colorize(:light_blue ).colorize( :background => :red).swap
puts "This is blue text on red".blue.on_red.hide
puts "This is red on blue".colorize(:red).on_blue
puts "This is red on blue and underline".colorize(:red).on_blue.underline
puts "This is blue text on red".blue.on_red.blink
puts "This is uncolorized".blue.on_red.uncolorize.blink
